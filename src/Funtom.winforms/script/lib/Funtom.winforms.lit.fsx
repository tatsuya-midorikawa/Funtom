(* ----------------------------------------------
 *       Funtom.winforms.lit ver. 0.0.1.1
 *             Apache-2.0 license
 * ｩ2024 Tatsuya Midorikawa. All rights rserved
 * ---------------------------------------------- *)
...
module dialogs =
  ...
  type dir_browser () =
    ...
    member __.show (?owner: System.Windows.Forms.IWin32Window) = match owner with Some v -> raw'.ShowDialog(v) | None -> raw'.ShowDialog()
